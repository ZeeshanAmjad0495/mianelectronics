...
const SMALL_APPLIANCES = Products.SmallAppliances;
const numberOfItems = SMALL_APPLIANCES.length;
  ...
  return (
    <div>
      ...
      <div className="content__main">
        ...
        <CardGrid data={SMALL_APPLIANCES} productsPerPage={productsPerPage} />
      </div>
